...
class Lobby:
    def __init__(self):
        ...
        bg_ip = ur.Entity(model=ur.Quad(aspect=5, radius=.1), parent=ur.camera.ui, color="#5e5e5e", scale=(.5, 0.05), position=(0.5, 0.085))
        ...
        bg_port = ur.Entity(model=ur.Quad(aspect=5, radius=.1), parent=ur.camera.ui, color="#5e5e5e", scale=(.5, 0.05), position=(0.5, 0.01))
        self.server_port = ur.InputField(parent=bg_port, model=ur.Quad(aspect=5, radius=.1), default_value='', limit_content_to="0123456789", character_limit=5, scale=(0.98, 0.85), color="#333333")
        ...
        self.Dropdown.options = ['default', 'Skin 1', 'Skin 2', 'Skin 3', 'Skin 4']
